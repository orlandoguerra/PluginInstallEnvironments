...
public class ReloadXmlQueuesAction implements IWorkbenchWindowActionDelegate{
	...
	public void run(IAction arg0) {
		try{
			...
			Utility.executePhythonCredential("YTBPortalRestartBoostrap.py", serverConfig.get("webSphereProfileName"),  
					serverConfig.get("wasInstallPortal"),fwkView, userPortal , pwdPortal);
