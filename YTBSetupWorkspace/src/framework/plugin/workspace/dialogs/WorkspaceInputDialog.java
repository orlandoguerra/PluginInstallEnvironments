 ...
 */
public class WorkspaceInputDialog extends TitleAreaDialog {
  ...
  private boolean valueSelectedProfile;
  private Combo comboDropDown;
  private List<String> bipDirectories;
  private String pfaVersion;
  private String currentPfaVersion;

  public WorkspaceInputDialog(Shell parentShell, List<String> bipDirectories, String currentPfaVersion) {
    super(parentShell);
  ...
  private void saveInput() {
	  ...
	  valueSelectedProfile = buttonProfile.getSelection();
  ...
  private void createCheckOptions(Composite container) {
	  buttonProfile =  new Button(container, SWT.CHECK);
	  buttonProfile.setSelection(true);
	  buttonProfile.setText("Create && Configure Rest Profile");
  ...
  protected void okPressed() {
    ...
    String errors = "";
	  ...
	  if(valueSelectedProfile == true && valueProfile.equals(""))
  ...
  public boolean isValueSelectedProfile() {
		return valueSelectedProfile;
  }
